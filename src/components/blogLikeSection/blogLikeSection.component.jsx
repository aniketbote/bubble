...
const BlogLikes = ({vote_count,blog_id,disable,voteDisable})=>{
    ...
    useEffect(()=>{
        if(blog_id!==undefined){
            ...
            fetch('https://****cs78h5.execute-api.us-east-1.amazonaws.com/v1/get_vote_val'+postfix,{
              method:'GET', 
              headers: {
    ...
    const post_vote = (vote) =>{
        ...
        fetch('https://****cs78h5.execute-api.us-east-1.amazonaws.com/v1/set_vote',{
            method:'POST', 
            headers: {
                'Content-Type': 'application/json',
                'Access-Control-Allow-Origin':'*'
