...
const QuestionPage = ()=>{
    ...
    useEffect(()=>{
        fetch('https://****cs78h5.execute-api.us-east-1.amazonaws.com/v1/get_question',{
            method:'POST',
            headers: {
            ...
            <div style={{display:'flex',flexDirection:'row',flexGrow:1}}>
                <div className='left-column' style={{flexDirection:'column',flexGrow:1}}>
                    ...
                    <div style={{paddingLeft:'10px',flexGrow:1}}>
                        ...
                        <p className='time-text'>Asked by <span className='user-text'>{data.username}</span> {timeDifference(data.timestamp)}. {data.edited?<span> (edited  {timeDifference(data.edited_timestamp)}). </span>:null}</p>       
                    </div>
